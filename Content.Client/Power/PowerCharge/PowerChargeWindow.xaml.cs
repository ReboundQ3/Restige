...
public sealed partial class PowerChargeWindow : FancyWindow
{
    ...
    public void UpdateState(PowerChargeState state)
    {
        ...
        PowerLabel.FontColorOverride = MathHelper.CloseTo(state.PowerDraw, state.PowerDrawMax)
            ? SVPalettes.Status.Good
            : SVPalettes.Status.Warning;
        ...
        {
            PowerChargePowerStatus.Off => SVPalettes.Status.Critical,
            PowerChargePowerStatus.Discharging => SVPalettes.Status.Warning,
            PowerChargePowerStatus.Charging => SVPalettes.Status.Warning,
            PowerChargePowerStatus.FullyCharged => SVPalettes.Status.Good,
            _ => throw new ArgumentOutOfRangeException()
        });
