...
public sealed partial class ChangelingTransformBoundUserInterface(EntityUid owner, Enum uiKey) : BoundUserInterface(owner, uiKey)
{
    ...
    private static readonly Color SelectedOptionBackground = SVPalettes.Green.Element.WithAlpha(128);
    private static readonly Color DisabledOptionBackground = SVPalettes.Deck.Element.WithAlpha(128);
    private static readonly Color SelectedOptionHoverBackground = SVPalettes.Green.HoveredElement.WithAlpha(128);
    private static readonly Color DisabledOptionHoverBackground = SVPalettes.Deck.HoveredElement.WithAlpha(128);
