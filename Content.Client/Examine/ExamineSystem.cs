...
namespace Content.Client.Examine
{
    ...
    public sealed partial class ExamineSystem : ExamineSystemShared
    {
        ...
        /// <param name="displayTarget">An optional entity to display the examine results for; if null we use <paramref name="entity"/>.</param>
        public void DoExamine(EntityUid entity, bool centeredOnCursor = true, EntityUid? userOverride = null, EntityUid? displayTarget = null) // Offbrand: added displayTarget
        {
